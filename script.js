  ...
  data() {
    return {
      ...
      about: { 
        ...
        text:`
        我們專注於網路規劃建設與資訊系統整合服務，是一家位於台灣的系統整合公司，專注於 GPU 伺服器、企業網路、零信任資安與全快閃儲存。以穩定性、安全性與效能為核心，為企業打造面向 AI 時代的最佳 IT 解決方案。
        凱茂資訊自成立以來，始終秉持「專業服務、誠信經營、永續成長」的核心理念，致力於為企業提供值得信賴的資訊解決方案。以國際化發展為目標，持續強化技術實力與服務品質，期望與客戶共同成長，打造雙贏合作模式。
        `
      },
